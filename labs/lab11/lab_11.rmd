...
**A1. The top ten words generally look like they describe acting negligently or mishandling money on the part of the attorney. The most common word is "failing," and some other words in the list include "account," "funds," and "conduct."**
...
**A2. The top trigram is "conduct involving dishonesty," appearing 155 times (3.3% of trigrams). It seems to be a standard term used a lot to describe lawyer misconduct or violations of ethical codes.**
...
```{r}
conduct <- md_attorney_sanctions |>
  filter(str_detect(text, "conduct involving dishonesty")) 

conduct |> group_by(fiscal_year) |> summarise(total_count = n()) |>
  arrange(desc(total_count))
```

**A3. It looks like 2021 was a big year for conduct involving dishonesty. It appeared 33 times in text during the 2021 fiscal year. This suggests that either the term increased in popularity (or became more well known among the law community), or more lawyers were caught behaving this way in 2021. I could probably reach out to an organization like the BARR Association and ask what the most common sanctions are for attorneys.**
