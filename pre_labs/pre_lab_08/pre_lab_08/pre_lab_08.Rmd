...
**Task** Complete and run the following code to create a dataframe of top 10 counties with the biggest change in unaffiliated voters in Maryland. In the space below, explain what each step of the code below is doing in English. **Answer: Looks at the difference between unaffiliated voters in 2024 and in 2022. Creates a column showing that difference. Creates a table including the top 10 greatest differences in descending order.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: Blank canvas.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: A bar chart with an x-axis of "County" and a y-axis of "count" (of UNAF_DIFF).**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: Arranged in ascending order.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: The graph's orientation has changed from vertical bars to horizontal bars, flipping the axes.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: Removed the gray backdrop.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer: The backdrop is now light blue and white. It changed the theme to The Economist's theme.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: Adds a title, renames the axis labels, and adds a caption.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: Table of number of contributions by date.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: A line chart of daily contributions to WinRed.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: Better adjusts scale to include weeks instead of days.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: Changes the angle of the x-axis labels.**
