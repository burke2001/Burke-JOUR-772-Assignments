...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer: Object ID, Zipcode 2, Zipname, Existing, Zipcode 1, Shape_Leng, Shape_Area, Geometry**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer: Takes us to the data table for MD Zips.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: The state of Maryland divided into zip codes.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Imports a new data table of counties.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Filters counties by just Maryland Counties.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Map of MD counties.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Overlaps counties and zip codes map.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Imports a new dataset on Maryland foreclosures by zip code.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Joins MD Zips dataset with the foreclosure data.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Creates a graph which shows density of foreclosures by zip code in Maryland, with a color scale.**
...
library(janitor)
library(tidycensus)
census_api_key("4582b72bb111b56cec693d5bf03e4d1b8981adfc")
```
...
**Task** Run the following code. Describe the output in the space below. **Answer: Load data sets on foreclosures by county and population by county.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Grabs ACS data on Maryland population by county from the 2017-2021 5-year ACS.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Shows the two datasets in tibbles.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Cleans up the county population data to have consistent names with the foreclosure dataset, to get it ready for joining.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Joins the Maryland foreclosures data with the Maryland county data.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Adds a new column calculating the rate of notices per 1,000 people in the county.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Creates a color-coded chart showing the rate of foreclosures per 1,000.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Creates a graph showing the rate of foreclosures per 1,000 with a different color palette, better showing differences per county.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: Tweaks the color palette to better show differences between counties. Also adjusts the numbers on the key to be more accurate.**

**It looks like, in general, northern Maryland counties tend to have lower rates of foreclosures than more southern counties.**
