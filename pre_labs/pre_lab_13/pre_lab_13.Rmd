...
**Answer: A tibble of all 50 states and their education spending, GDP, and population change for 2021, as well as their presidential popular vote in 2020.**
...
**Answer: A plot of all 50 states comparing their GDP growth and population change in 2021, with a line of best fit. The line slopes slightly positive.**
...
**Answer: A plot of all 50 states comparing their GDP growth with education spending per student. The line of best fit is slightly negative.**
...
**Answer: Weak negative correlation between GDP growth and education spending. A larger negative correlation between education spending and population growth. Lastly, a slightly positive correlation between GDP growth and population change.**
...
**Answer: Provides some more information on the data's correlation, including a small p-value of 0.00301.**
...
**Answer: Gives information on correlation like task 6. Shows its p-value of 0.6795.**
...
**Answer: Shows average GDP growth, education spending, and population growth in states that voted for Biden and those that voted for Trump in 2020. GDP and education spending grew at a higher number in Biden states, but population growth grew more on average in Trump states.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: A p-value of 0.07411, meaning there is more probability of the data just being coincidental.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: A much lower p-value than Task 9, indicating a more statistically significant correlation.**
