...
```{r}
library(axolotr)
create_credentials(GROQ_API_KEY = "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")
```
...
```{r}
groq_response <- axolotr::ask(
  prompt = "What does case_when do in R in non-jargony terms",
  model = "llama-3.1-8b-instant"
)
...
**Your comment: Groq actually did a decent job at explaining case_when to me. It took a couple tries prompting it to give a response that makes sense to someone like me who is unfamiliar with computer terms, but I eventually settled on an answer I was satisfied with. It seems accurate enough, with the little experience I have using case_when. My only nitpick is that grapes are purple and not green. They can be green, but I mostly associate them with being purple. That was a little distracting from helping me understand.**
