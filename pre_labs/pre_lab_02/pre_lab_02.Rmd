...
**Answer: It makes it easier for us to find the specific data we are looking for out of the 60,000 rows of data from UMD Courses.**
...
**Answer: The formatting of the expenditure_date column has changed form M/DD/YYYY to YYYY-MM-DD.**
...
**Answer: Months are now sorted by descending total amount spent, with the most expensive month on top.**
...
**Answer: It looks like the code is telling the computer to creating a new column that lists the name of the state taken from the payee's address. It also abbreviates the state name to its postal code, instead of spelling it out.**
...
**Answer: This answer does make sense. It takes the new column that we generated last time, and combines the total amount of money given to all the payees across each state.**
...
1.  Are certain zip codes in the state receiving considerably more money than others?

2.  How much of these expenses goes toward salaries and wages? Are some officials making more than they should be?

3.  This is a silly one, but the str_detect function could be use to find the amount of money going to addresses ending in Drive, Avenue, Boulevard, Lane, etc. Which of these street classifications are receiving the least amount of expenses?
