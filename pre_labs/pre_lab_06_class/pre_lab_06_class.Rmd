...
assessment <- read_csv('~/JOUR 772/Burke-JOUR-772-Assignments/pre_labs/pre_lab_06_class/assessment.csv') |> mutate(zipcode = as.character(zipcode)) 
```
...
maryland_zcta_assessment <- maryland_zcta |> left_join(assessment, join_by(ZCTA5N == zipcode)) 
```
