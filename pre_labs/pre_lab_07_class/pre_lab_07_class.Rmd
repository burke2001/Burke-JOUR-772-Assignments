...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer: Utah with 18.37% growth.**
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer: Howard County has the highest median income in MD, with an estimate of \$140,971.**
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer: Median Household Income by County in Maryland**
...
Is the difference between Calvert and Montgomery significant? **Answer: Yes, there is a gap between their estimates and MoEs.**

Is the difference between Howard and everyone else significant? **Answer: Maybe not - there is some overlap between their estimates and margins of error.**
...
**Add your answer here: Baltimore City, Garrett County, Allegany County, and Calvert County have the largest growths in income between 2012 and 2022.**
